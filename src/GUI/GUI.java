...
public class GUI extends JFrame{
    ...
    public void initialize() {
        ...
        frame.add(panel);
        frame.setTitle("123200120 - Daniel Febrian Eka Wijaya");
        ...
        loginButton.addActionListener(new ActionListenerActionListener() {
           @Override
        ...
        registerButton.addActionListener(new ActionListenerActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try {
